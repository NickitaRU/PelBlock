Module ModulePelBlock_Subs_Functions
	...
	Function FindTextBoxContentIndex(obj As Control) As Integer
		...
		For i = 0 To TextBoxContent.Count - 1
			If TextBoxContent(i)(0).name = obj.Name Then
				preres = i
				Exit For
			End If
		Next
	...
	Sub RecountTextBoxPr(obj As Control)
		...
		TextBoxContent(FindTextBoxContentIndex(obj))(0) = obj
		TextBoxContent(FindTextBoxContentIndex(obj))(1) = obj.Text
	End Sub

	Sub CreateTextBoxPr(obj As Control)
		TextBoxContent.Add(New List(Of Object) From {obj, obj.Text})
	...
	Function GetBlockClassTypeFromName(name As String)
		Dim preres As String = ""
