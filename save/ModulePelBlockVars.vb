Public Module ModulePelBlockVars
	...
	Public TextBoxContent As New List(Of List(Of Object))
	Public ProgTheme As String
	Public wasShown As Boolean
	Public ThemeBackColor As Color = Color.White
	Public ThemeForeColor As Color = Color.Black
End Module